...
$(document).ready(function () {
  ...
  $('#addConvoBtn').click(function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        $('#log').append(`<li>Conversation created/updated: ${conversationId}</li>`);
      ...
      error: function (error) {
        $('#log').append('<li>Error creating/updating conversation. Check console.</li>');
  ...
  window.reloadConversations = function () {
    ...
    $.ajax({
      ...
      error: function (error) {
        $('#log').append('<li>Error loading conversations. Check console.</li>');
